"""7 GUIs Circle Drawer

An implementation of the 7 GUIs Circle Drawer task. It is designed to
...
class CircleDrawer(ttk.Frame):
    """CircleDrawer encapsulates the GUI into an object to prevent
    namespace pollution.
    """
