...
An implementation of the 7 GUIs Flight Booker task. It is designed to
...
class FlightBooker(ttk.Frame):
    """FlightBooker encapsulates the GUI into an object to prevent
    namespace pollution.
    """
